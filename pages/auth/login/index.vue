<template>
  <div class="flex justify-center items-center h-screen">
    ...
    >
      <h1 class="text-3xl text-center mb-5 text-black mt-4 text-bold">Login</h1>
      <q-form class="flex flex-row justify-center items-center">
        <q-input
          v-model="username"
          unmasked-value
          label="Username *"
        ...
        >
          <div class="flex flex-row flex-nowrap justify-center items-center">
            <span class="flex-grow border-t border-gray-300 min-w-full" />
